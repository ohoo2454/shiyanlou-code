# -*- coding: utf-8 -*-
# Generated by Django 1.11.21 on 2021-01-01 01:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='class_teacher', to='web.UserInfo', verbose_name='班主任')),
                ...
                ('tech_teachers', models.ManyToManyField(blank=True, related_name='tech_teachers', to='web.UserInfo', verbose_name='任课老师')),
            ],
        ),
    ]
