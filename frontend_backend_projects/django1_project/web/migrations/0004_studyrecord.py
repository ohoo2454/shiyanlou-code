# -*- coding: utf-8 -*-
# Generated by Django 1.11.21 on 2021-01-05 03:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.CharField(choices=[('checked', '已签到'), ('vacate', '请假'), ('late', '迟到'), ('noshow', '缺勤'), ('leave_early', '早退')], default='checked', max_length=64, verbose_name='考勤记录')),
