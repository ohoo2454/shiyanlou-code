...
class PaymentRecord(models.Model):
    ...
    confirm_user = models.ForeignKey(verbose_name='审批人', to='UserInfo', 
                                     related_name='confirms', null=True, 
                                     blank=True)
...
class StudyRecord(models.Model):
    ...
    学生考勤记录模型类
    """
    course_record = models.ForeignKey(verbose_name='第几天课程', 
                                      to='CourseRecord')
    student = models.ForeignKey(verbose_name='学员', to='Student')
    record_choices = [
        ('checked', "已签到"),
    ...
    record = models.CharField(verbose_name='考勤记录', choices=record_choices, 
                              default='checked', max_length=64)
